...
| Как получить для переменной `c` значение 12?  | Для получения значения 12 в переменной c, необходимо привести переменную b к типу int и выполнить операцию сложения, например: |![Снимок](https://user-images.githubusercontent.com/123774335/231793411-d42daf88-88b0-4b2d-841e-ed7d7fabb79b.PNG)
