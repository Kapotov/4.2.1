...
| Как получить для переменной `c` значение 12?  | Для получения значения 12 в переменной c, необходимо привести переменную b к типу int и выполнить операцию сложения, например:
![Снимок](https://user-images.githubusercontent.com/123774335/231794404-b186507e-9464-4f3d-9f73-5969d5efd88a.PNG)
